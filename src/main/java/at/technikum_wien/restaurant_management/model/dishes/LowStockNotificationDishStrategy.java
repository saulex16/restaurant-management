...
@Component
public class LowStockNotificationDishStrategy implements StockNotificationDishStrategy {

    private final DishRepository dishRepository;

    @Autowired
    public LowStockNotificationDishStrategy(DishRepository dishRepository) {
